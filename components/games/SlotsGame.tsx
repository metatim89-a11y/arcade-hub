  ...
  return (
    <section className="slots-game">
      ...
      <style>{`
        ...
        .slots-reels:after{content:'';position:absolute;z-index:7;inset:7px;pointer-events:none;border-radius:7px;background:linear-gradient(rgba(255,255,255,.24),transparent 18%,transparent 76%,rgba(24,12,30,.3)),radial-gradient(ellipse at 50% 50%,transparent 45%,rgba(13,5,18,.2) 100%);box-shadow:inset 0 14px 22px rgba(255,255,255,.12),inset 0 -20px 24px rgba(20,5,27,.3)}.slot-reel:before,.slot-reel:after{content:'';position:absolute;z-index:4;left:0;right:0;height:23%;pointer-events:none}.slot-reel:before{top:0;background:linear-gradient(rgba(45,35,48,.48),transparent)}.slot-reel:after{bottom:0;background:linear-gradient(transparent,rgba(45,35,48,.5))}.slot-symbol{background:linear-gradient(90deg,rgba(110,102,114,.18),rgba(255,255,255,.42) 22%,rgba(255,255,255,.72) 50%,rgba(255,255,255,.42) 78%,rgba(110,102,114,.18));text-shadow:0 2px 1px white}.slot-symbol span{transform:perspective(260px) rotateX(-1deg);filter:drop-shadow(0 4px 3px rgba(0,0,0,.28))}.hold-spin-board{padding:10px;border:1px solid #a47b27;border-radius:10px;background:radial-gradient(circle,#3c2609,#130b05);box-shadow:inset 0 0 35px #000}.hold-spin-header{display:flex;justify-content:space-between;align-items:center;padding:2px 4px 9px;color:#ffd969;font-size:10px;font-weight:950;letter-spacing:.12em}.hold-spin-grid{display:grid;grid-template-columns:repeat(5,1fr);gap:7px}.hold-spin-grid>div{display:grid;place-items:center;min-height:78px;border:1px dashed #5e4b2c;border-radius:9px;background:rgba(8,5,3,.6);color:#57482f}.hold-spin-grid>div.held{position:relative;border:2px solid #ffd25a;background:radial-gradient(circle,#fff1a4 0,#e0a323 40%,#7c480d 76%);box-shadow:0 0 15px rgba(255,204,73,.5),inset 0 0 0 4px rgba(255,255,255,.16);color:#442504}.hold-spin-grid span{font-size:34px}.hold-spin-grid strong{position:absolute;font-size:13px}.hold-spin-grid small{position:absolute;margin-top:29px;font-size:7px;font-weight:950}.hold-spin-grid i{font-size:20px;font-style:normal}.hold-spin-board.rolling .hold-spin-grid>div:not(.held){animation:bonus-cell .22s infinite alternate}@keyframes bonus-cell{to{background:rgba(255,204,73,.12);border-color:#9a7739}}

  ...
  return (
    <section className="crash-game" aria-label="Crash game">
      ...
      <style>{`
        ...
        @media(max-width:430px){.crash-game{padding:8px}.crash-header{margin-bottom:7px}.crash-header h2{font-size:23px}.crash-stage{height:230px}.crash-readout strong{font-size:46px}.crash-message{min-height:34px;margin:7px 0;padding:6px 8px;font-size:10px}.crash-panel{grid-template-columns:1fr 1fr;gap:7px;padding:8px}.crash-action-column{grid-column:1/-1;grid-row:1}.crash-bet-column{grid-column:1;grid-row:2}.crash-auto-column{grid-column:2;grid-row:2}.crash-action{min-height:54px}.crash-bet-input{grid-template-columns:30px 1fr 30px}.crash-auto-input{min-height:36px}.crash-footer{padding-top:7px}}
        @media(prefers-reduced-motion:reduce){.shaking{animation:none!important}}
      `}</style>
    </section>
  );
};

...
import ColorRecall3D from './ColorRecall3D';
  ...
  return (
    <section className="color-recall-game" aria-label="Color Recall memory game">
      ...
      <div className={`color-recall-stage ${phase.toLowerCase()}`}>
        ...
        <div className="color-recall-3d"><ColorRecall3D activePad={activePad} phase={phase} onPad={handlePad} /></div>
        <div className="color-recall-readout" aria-hidden="true"><strong>{phase === 'SHOWING' ? 'WATCH' : phase === 'INPUT' ? 'REPEAT' : phase === 'GAME_OVER' ? 'MISS' : 'READY'}</strong><small>{phase === 'INPUT' ? `${progress}/${sequence.length}` : `LV ${level}`}</small></div>
      ...
      <style>{`
        .color-recall-game{width:min(100%,720px);margin:auto;padding:18px;border:1px solid #33485c;border-radius:20px;background:radial-gradient(circle at 50% 30%,#182b3d,#08111b 66%);box-shadow:0 25px 70px rgba(0,0,0,.42);color:#eef7ff;user-select:none}.color-recall-header{display:flex;justify-content:space-between;align-items:flex-end;gap:16px;padding:3px 4px 16px}.color-recall-header>div:first-child span{color:#7fc8f0;font-size:9px;font-weight:950;letter-spacing:.18em}.color-recall-header h2{margin:3px 0 0;font-size:28px;line-height:1}.color-recall-stats{display:flex;gap:7px}.color-recall-stats span{display:grid;place-items:center;min-width:64px;padding:7px;border:1px solid #37516a;border-radius:8px;background:#0a1622;color:#dceefe;font-size:16px;font-weight:950}.color-recall-stats small{color:#6f8ba2;font-size:7px;letter-spacing:.12em}.color-recall-stage{display:flex;flex-direction:column;align-items:center;padding:14px;border:1px solid #263c50;border-radius:15px;background:linear-gradient(rgba(8,18,28,.86),rgba(5,11,18,.94))}.color-recall-status{display:flex;align-items:center;justify-content:center;gap:9px;width:100%;min-height:40px;color:#b9cbd9;font-size:12px;text-align:center}.color-recall-status i{width:8px;height:8px;border-radius:50%;background:#617789}.color-recall-stage.showing .color-recall-status i{background:#f3c850;box-shadow:0 0 12px #f3c850;animation:recall-pulse .7s infinite}.color-recall-stage.input .color-recall-status i{background:#61dea7;box-shadow:0 0 12px #61dea7}.color-recall-stage.game_over .color-recall-status i{background:#ed5b68;box-shadow:0 0 12px #ed5b68}.color-recall-3d{width:min(90vw,500px);height:420px;margin:-8px 0 -34px;filter:drop-shadow(0 20px 26px rgba(0,0,0,.5))}.color-recall-readout{z-index:2;display:grid;place-items:center;min-width:112px;margin-bottom:12px;padding:8px 16px;border:1px solid #4c7189;border-radius:20px;background:#08131dcc;box-shadow:0 7px 18px #0008}.color-recall-readout strong{font-size:12px;letter-spacing:.12em}.color-recall-readout small{color:#7992a6;font-size:9px}.sequence-progress{display:flex;flex-wrap:wrap;justify-content:center;gap:5px;min-height:12px;max-width:420px}.sequence-progress i{width:7px;height:7px;border-radius:50%;background:#26394a}.sequence-progress i.current{background:#f0c852;box-shadow:0 0 8px #f0c852}.sequence-progress i.correct{background:#53d69d}.color-recall-start{min-width:210px;margin-top:18px;padding:13px 22px;border:1px solid #9bc7df;border-radius:10px;background:linear-gradient(#e7f6ff,#8cbdd7);box-shadow:0 5px 0 #426e87;color:#102230;font-size:14px;font-weight:950;letter-spacing:.08em;cursor:pointer}.color-recall-start:active{transform:translateY(4px);box-shadow:0 1px 0 #426e87}.color-recall-stage p{max-width:480px;margin:15px 0 2px;color:#70889b;font-size:10px;text-align:center}.color-recall-stage.showing .color-recall-start{opacity:.55}.color-recall-stage.showing .color-recall-start:hover{opacity:.8}@keyframes recall-pulse{50%{opacity:.35;transform:scale(.75)}}@media(max-width:560px){.color-recall-game{padding:11px}.color-recall-header{align-items:flex-start;flex-direction:column}.color-recall-stats{width:100%}.color-recall-stats span{flex:1;min-width:0}.color-recall-3d{height:340px;margin:-10px 0 -28px}.color-recall-header h2{font-size:24px}}@media(prefers-reduced-motion:reduce){.color-recall-stage.showing .color-recall-status i{animation:none!important}}
      `}</style>
    </section>
  );
};
